...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.start) {
            if (Integer.parseInt(k.getText().toString()) <= Integer.parseInt(n.getText().toString()) & Integer.parseInt(k.getText().toString()) >= 0 & Integer.parseInt(n.getText().toString()) >= 0) {
                ...
                Toast toast = Toast.makeText(getApplicationContext(), "Incorrect input data", Toast.LENGTH_SHORT);
                toast.show();
            }
        }
    }
